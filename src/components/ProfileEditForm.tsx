...
export function ProfileEditForm() {
      ...
      <div className="space-y-4">
            ...
            {profile.jobPreferences.roles.map((role: string, index: number) => (
              <Badge key={index} variant="secondary" className="flex items-center gap-1 py-1.5">
                ...
                <Button
                  ...
                  size="icon"
                  className="h-4 w-4 p-0 ml-1"
                  onClick={() => handleJobPreferenceChange('roles', 
                    profile.jobPreferences.roles.filter((r: string) => r !== role)
                  )}
                >
                  <X className="h-3 w-3" />
                </Button>
            ...
            onKeyDown={(e) => {
              if (e.key === 'Enter' && e.currentTarget.value.trim()) {
                ...
                if (!profile.jobPreferences.roles.includes(newRole)) {
                  handleJobPreferenceChange('roles', [...profile.jobPreferences.roles, newRole]);
            ...
            {profile.jobPreferences.industries.map((industry: string, index: number) => (
              <Badge key={index} variant="secondary" className="flex items-center gap-1 py-1.5">
                ...
                <Button
                  ...
                  size="icon"
                  className="h-4 w-4 p-0 ml-1"
                  onClick={() => handleJobPreferenceChange('industries', 
                    profile.jobPreferences.industries.filter((i: string) => i !== industry)
                  )}
                >
                  <X className="h-3 w-3" />
                </Button>
          ...
          <Input
            ...
            onKeyDown={(e) => {
              if (e.key === 'Enter' && e.currentTarget.value.trim()) {
                ...
                if (!profile.jobPreferences.industries.includes(newIndustry)) {
                  handleJobPreferenceChange('industries', [...profile.jobPreferences.industries, newIndustry]);
                  e.currentTarget.value = '';
                }
              }
            }}
            ...
            {profile.jobPreferences.companies.map((company: string, index: number) => (
              <Badge key={index} variant="secondary" className="flex items-center gap-1 py-1.5">
                ...
                <Button
                  ...
                  size="icon"
                  className="h-4 w-4 p-0 ml-1"
                  onClick={() => handleJobPreferenceChange('companies', 
                    profile.jobPreferences.companies.filter((c: string) => c !== company)
                  )}
                >
                  <X className="h-3 w-3" />
                </Button>
          ...
          <Input
            ...
            onKeyDown={(e) => {
              if (e.key === 'Enter' && e.currentTarget.value.trim()) {
                ...
                if (!profile.jobPreferences.companies.includes(newCompany)) {
                  handleJobPreferenceChange('companies', [...profile.jobPreferences.companies, newCompany]);
                  e.currentTarget.value = '';
                }
              }
            }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormItem>
            ...
            <FormControl>
              <div className="relative">
                <div className="absolute left-2 top-2.5 text-muted-foreground">$</div>
                <Input
                  type="number"
                  value={profile.jobPreferences.compensation.minimum}
                  onChange={(e) => handleJobPreferenceChange('compensation', {
          ...
          <FormItem>
            <FormLabel>Target Compensation</FormLabel>
            <FormControl>
              <div className="relative">
                <div className="absolute left-2 top-2.5 text-muted-foreground">$</div>
                <Input
        ...
        <FormItem>
            ...
            {profile.jobPreferences.jobTypes.map((type: string, index: number) => (
              <Badge key={index} variant="secondary" className="flex items-center gap-1 py-1.5">
                ...
                <Button
                  ...
                  size="icon"
                  className="h-4 w-4 p-0 ml-1"
                  onClick={() => handleJobPreferenceChange('jobTypes', 
                    profile.jobPreferences.jobTypes.filter((t: string) => t !== type)
                  )}
                >
                  <X className="h-3 w-3" />
                </Button>
          ...
          <Select
            onValueChange={(value) => {
              if (!profile.jobPreferences.jobTypes.includes(value)) {
                handleJobPreferenceChange('jobTypes', [...profile.jobPreferences.jobTypes, value]);
              }
            }}
          >
            <SelectTrigger>
              <SelectValue placeholder="Add job type" />
            </SelectTrigger>
            <SelectContent>
  ...
  const WorkAuthorizationForm = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-medium mb-2">Work Authorization</h3>
        <p className="text-sm text-muted-foreground">
          Add your work authorization status to help connect with relevant opportunities.
        </p>
      </div>
      ...
      <FormItem>
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="permanent-resident">U.S. Permanent Resident</SelectItem>
            <SelectItem value="authorized-to-work">Authorized to work in the U.S.</SelectItem>
            <SelectItem value="requires-sponsorship">Require sponsorship now or in the future</SelectItem>
            <SelectItem value="student-visa">Student Visa (F-1, J-1, etc.)</SelectItem>
  ...
  const DemographicsForm = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-medium mb-2">Demographics (Optional)</h3>
        <p className="text-sm text-muted-foreground">
          This information is optional and helps companies with their diversity initiatives.
        </p>
      </div>
      ...
      <FormItem>
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="non-binary">Non-binary/Non-conforming</SelectItem>
      ...
      <FormItem>
        ...
        <Select
          ...
          onValueChange={(value) => handleDemographicChange('disabilityStatus', value)}
        >
          <SelectTrigger>
            <SelectValue placeholder="Select disability status" />
          </SelectTrigger>
          <SelectContent>
            <SelectItem value="has-disability">Yes, I have a disability</SelectItem>
            <SelectItem value="no-disability">No, I don't have a disability</SelectItem>
            <SelectItem value="prefer-not-to-say">Prefer not to say</SelectItem>
          </SelectContent>
        </Select>
      </FormItem>
  ...
  // Render selected section's form
  const renderSection = () => {
  ...
  const SectionNav = () => (
    <div className="space-y-1">
      <button
        className={`w-full text-left px-3 py-2 rounded-md ${activeSection === "basic" ? "bg-primary text-primary-foreground" : "hover:bg-muted"}`}
        onClick={() => setActiveSection("basic")}
      >
        Basic Information
      </button>
      <button
        className={`w-full text-left px-3 py-2 rounded-md ${activeSection === "contact" ? "bg-primary text-primary-foreground" : "hover:bg-muted"}`}
        onClick={() => setActiveSection("contact")}
      >
        Contact Information
      </button>
      <button
        className={`w-full text-left px-3 py-2 rounded-md ${activeSection === "workExperience" ? "bg-primary text-primary-foreground" : "hover:bg-muted"}`}
        onClick={() => setActiveSection("workExperience")}
      >
        Work Experience
      </button>
      <button
        className={`w-full text-left px-3 py-2 rounded-md ${activeSection === "education" ? "bg-primary text-primary-foreground" : "hover:bg-muted"}`}
        onClick={() => setActiveSection("education")}
      >
        Education
      </button>
      <button
        className={`w-full text-left px-3 py-2 rounded-md ${activeSection === "projects" ? "bg-primary text-primary-foreground" : "hover:bg-muted"}`}
        onClick={() => setActiveSection("projects")}
      >
        Projects
      </button>
      <button
        className={`w-full text-left px-3 py-2 rounded-md ${activeSection === "social" ? "bg-primary text-primary-foreground" : "hover:bg-muted"}`}
        onClick={() => setActiveSection("social")}
      >
        Social Links
      </button>
      <button
        className={`w-full text-left px-3 py-2 rounded-md ${activeSection === "skills" ? "bg-primary text-primary-foreground" : "hover:bg-muted"}`}
        onClick={() => setActiveSection("skills")}
      >
        Skills & Qualifications
      </button>
      <button
        className={`w-full text-left px-3 py-2 rounded-md ${activeSection === "jobPreferences" ? "bg-primary text-primary-foreground" : "hover:bg-muted"}`}
        onClick={() => setActiveSection("jobPreferences")}
      >
        Job Preferences
      </button>
      <button
        className={`w-full text-left px-3 py-2 rounded-md ${activeSection === "workAuthorization" ? "bg-primary text-primary-foreground" : "hover:bg-muted"}`}
        onClick={() => setActiveSection("workAuthorization")}
      >
        Work Authorization
      </button>
      <button
        className={`w-full text-left px-3 py-2 rounded-md ${activeSection === "demographics" ? "bg-primary text-primary-foreground" : "hover:bg-muted"}`}
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="right" className="sm:max-w-2xl w-full overflow-y-auto">
        <SheetHeader>
          ...
          <SheetDescription>
            Update your profile information to make it easier for recruiters to find you.
          </SheetDescription>
        </SheetHeader>
        <div className="py-4">
    ...
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent className="h-[85vh] max-h-[85vh] overflow-y-auto">
        ...
        <div className="px-4 pb-0">
          ...
          <Progress value={profileCompletion} className="w-full h-2 mb-4" />
          
          <Select
            value={activeSection}
            onValueChange={(value: any) => setActiveSection(value)}
          >
            <SelectTrigger>
            ...
            <SelectContent>
              ...
              <SelectItem value="skills">Skills & Qualifications</SelectItem>
              <SelectItem value="jobPreferences">Job Preferences</SelectItem>
              <SelectItem value="workAuthorization">Work Authorization</SelectItem>
  ...
  return (
    <>
      {window.innerWidth >= 768 ? <DesktopContent /> : <MobileContent />}
    </>
  );
}
