          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-sm font-medium">{matchScore.overall}%</span>
              </div>
              <Progress 
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
            ...
            <CollapsibleContent className="p-4 border border-gray-200 rounded-lg mt-2">
              <div className="space-y-3">
                {matchScore.missingSkills.length > 0 && (
                  <div>
                    <h5 className="font-medium text-red-600 mb-2">Missing Skills:</h5>
                    <div className="flex flex-wrap gap-2">
                ...
                {matchScore.matchingSkills.length > 0 && (
                  <div>
                    <h5 className="font-medium text-green-600 mb-2">Matching Skills:</h5>
                    <div className="flex flex-wrap gap-2">
          ...
          <Collapsible open={experienceExpanded} onOpenChange={setExperienceExpanded}>
            ...
            <CollapsibleContent className="p-4 border border-gray-200 rounded-lg mt-2">
              <p className="text-sm text-gray-600">
                Experience match is based on your skills match.
              </p>
            </CollapsibleContent>
          </Collapsible>
          ...
          <Collapsible open={educationExpanded} onOpenChange={setEducationExpanded}>
            ...
            <CollapsibleContent className="p-4 border border-gray-200 rounded-lg mt-2">
              <p className="text-sm text-gray-600">
                Education match is based on your skills match.
              </p>
            </CollapsibleContent>
          </Collapsible>
          ...
          <Collapsible open={locationExpanded} onOpenChange={setLocationExpanded}>
            ...
            <CollapsibleContent className="p-4 border border-gray-200 rounded-lg mt-2">
              <p className="text-sm text-gray-600">
                Location is not considered in this match calculation.
              </p>
            </CollapsibleContent>
          </Collapsible>
        </CardContent>
