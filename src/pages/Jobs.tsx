    ...
    <div className="min-h-screen flex flex-col bg-secondary/30">
      ...
      <main className="flex-1 pt-20">
        <div className="container px-4 py-8">
                ...
                <Dialog open={showPostJobDialog} onOpenChange={setShowPostJobDialog}>
                  ...
                  <DialogContent className="sm:max-w-[600px]">
                    ...
                    <div className="grid gap-4 py-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <Label htmlFor="salary-min">Minimum Salary (in thousands)</Label>
                          <Input 
                            id="salary-min"
                            type="number"
                        ...
                        <div>
                          <Label htmlFor="salary-max">Maximum Salary (in thousands)</Label>
                          <Input 
                            id="salary-max"
                            type="number"
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox 
                          ...
                          onCheckedChange={(checked) => 
                            setNewJob({...newJob, remote: checked === true})}
                        />
          ...
          {/* Additional UI components and layout would go here */}
